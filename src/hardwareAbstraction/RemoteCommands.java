...
/**
 * 
 * Contains a list of integer commands to communicate to the
 * {@link NXTRemoteMotor} and {@link NXTRemoteUltrasonicPoller}.
 * <p>
 * 0-49 is reserved for RemoteMotor. These commands correspond to the available
 * methods of the {@link NXTRegulatedMotor}
 * <p>
 * 50+ is reserved from Remote Ultrasonic Poller. These commands correspond to
 * the available methods of the {@link UltrasonicPoller} interface.
 * 
