...
/**
 * Prints Information to the LCD display of the NXT. This includes
 * {@link Odometer} x, y, theta; a debug value, and the next point in the Route
 * of {@link Navigation}.
 * 
...
public class LCDInfo implements TimerListener {
	...
	/**
	 * Main update loop. Updates the Odometer values, debug value, and next
	 * Point in the route in {@link Navigation} value on the LCD screen. The
	 * screen is primarily used for debugging purposes.
	 * <p>
	 * x, y are in mm. Theta is in degrees
	 * <p>
	 * This method still needs work as it sometimes causes errors. Was not used
	 * for the final demo but is still useful so it is left here.
	 */
	public void timedOut() {
		...
		/*
		 * LCD.drawString("L: ", 0, 4); LCD.drawString("C: ", 0, 5);
