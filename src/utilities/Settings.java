...
/**
 * Contains most of the Motor/Sensor port settings, Physical Robot Parameters
 * and match settings
 */
public class Settings {
	 ...
	 * left line sensor
	 */
	public static ColorSensor rearLeftColorSensor = new ColorSensor(
			SensorPort.S2);
	/**
	 * Right line sensor
	 */
	public static ColorSensor rearRightColorSensor = new ColorSensor(
			SensorPort.S3);
	...
	/**
	 * The motor id that corresponds to the Claw motor. Used by
	 * {@link NXTRemoteControl}
	 */
	public static final int CLAW_MOTOR_ID = 1;
	/**
	 * The motor id that corresponds to the Ultrasonic motor. Used by
	 * {@link NXTRemoteControl}
	 */
	public static final int ULTRASONIC_MOTOR_ID = 2;
	/**
	 * The motor id that corresponds to the Lift motor. Used by
	 * {@link NXTRemoteControl}
	 */
	...
	/**
	 * Array of points corresponding to the red zone, set by
	 * {@link BluetoothTransmission}
	 */
	public static Point[] redZoneCoords = { new Point(240, 240),
			new Point(90, 90) };

	public static Tile redZone = new Tile(redZoneCoords[0], redZoneCoords[1]);
	/**
	 * Array of points corresponding to the green zone, set by
	 * {@link BluetoothTransmission}
	 */
	public static Point[] greenZoneCoords = { new Point(180, 180),
			new Point(210, 210) }; // TODO remove once BT is working.

	public static Tile greenZone = new Tile(greenZoneCoords[0],
			greenZoneCoords[1]);
	/**
	...
	/**
	 * Distance from the odometry centre to the line that passes through both
	 * line sensors
	 */
	...
	/**
	 * the distance from the end of the claw to the front of the ultrasonic
	 * sensor
	 */
	public static final int tipOfClawToUSDistance = 18; // TODO measure this.
	/**
	 * the distance from the middle of the claw to the front of the ultrasonic
	 * sensor
	 */
