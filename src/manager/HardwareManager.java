...
/**
 * Initializes all sensor classes and appropriate motor classes. Provides access
 * to sensor pollers and motor classes.
 */
public class HardwareManager {
	...
	public Claw claw;
	/**
	 * Handles the ultrasonic motor. Rotates the Ultrasonic sensors to the
	 * forward or side facing positions
	 */
	...
	/**
	 * Handles interaction with the remote ultrasonic poller. Provides methods
	 * to set the mode of the poller and retrieve filtered data from each sensor
	 */
	...
	public HardwareManager(Manager manager) {
		...
		this.ultrasonicPoller = new NXTRemoteUltrasonicPoller(
				manager.um.command, 4);

	}

	/**
	 * Resets the motors to their default starting position. Also stops the stop
	 * before doing so.
	 */
	public void reset() {
