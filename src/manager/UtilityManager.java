...
/**
 * Initiates the RS485 Connection and the Bluetooth Connection to the server. It
 * will set the appropriate match parameters in {@link Settings}
 * <p>
 * It will also initialize the appropriate {@link NXTRemoteMotor} motors and
 * sets them in {@link Settings}
 */
public class UtilityManager {
	...
	public UtilityManager(Manager manager) {
		...
		Settings.ultrasonicMotor = new NXTRemoteMotor(command,
				Settings.ULTRASONIC_MOTOR_ID);
	 ...
	 * 
	 * @param time
	 *            int value which represents the sleep time
	 */
