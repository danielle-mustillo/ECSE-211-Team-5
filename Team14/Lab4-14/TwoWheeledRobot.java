...
public class TwoWheeledRobot {
	public static final double DEFAULT_LEFT_RADIUS = 2.08;
	public static final double DEFAULT_RIGHT_RADIUS = 2.08;
	public static final double DEFAULT_WIDTH = 15.24;
	private NXTRegulatedMotor leftMotor, rightMotor;
	private double leftRadius, rightRadius, width;
	private double forwardSpeed, rotationSpeed;
	public enum StartingPosition { FACING_WALL, FACING_OPEN };
